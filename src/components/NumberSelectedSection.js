    ...
    return (
        <div className="NumberSection">
            <div className="Number-rows nochange">
                ...
                <button onClick={cashButtonClicked} className="confirms-buttons noChange"> Cash </button>                
                <button onClick={clearButtonClicked} className="confirms-buttons noChange"> Clear </button> 
                <button onClick={randomButtonClicked} className="random-buttons noChange"> Random </button>
            </div>
        </div>
    )
